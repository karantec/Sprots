...
const { insertBookmakerOddsData, fetchBookmakerOdds, insertFancyOddsData, storeFancyDataToRedis, getFancyDataFromRedis,fetchFancyOddsCached } = require('../controller/Book.Controller');
